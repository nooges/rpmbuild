...
%{perl_vendorlib}/Git/SVN/GlobSpec.pm
%{perl_vendorlib}/Git/SVN/Log.pm
%{perl_vendorlib}/Git/SVN/Migration.pm
%{perl_vendorlib}/Git/SVN/Utils.pm

%changelog
* Mon Jul 23 2012 David Hrbáč <david@hrbac.cz> - 1.7.11.3-1
